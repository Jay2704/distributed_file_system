...
class ChunkServer:
    """
    Chunk Server 3 for Distributed File System
    ...
    def __init__(self, ip, port, chunk_server_id, master_ip, master_port):
        """
        Initialize Chunk Server 3
        
        Args:
            ip (str): IP address to bind the chunk server to
            port (int): Port number to listen on (6003 for Chunk Server 3)
            chunk_server_id (int): Unique identifier for this chunk server (3)
    ...
    def register_with_master(self):
        """
        Register Chunk Server 3 with the master server
    ...
    def handle_client(self, client_socket, addr):
        """
        Handle incoming client requests for Chunk Server 3
    ...
    def start(self):
        """
        Start Chunk Server 3 and begin listening for client connections
...
if __name__ == "__main__":
    # Create and start Chunk Server 3 on localhost port 6003
